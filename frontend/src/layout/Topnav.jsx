  ...
  const [logggedIn, setLoggedIn] = useState(false);
     ...
     return ( 
        ...
        <div className='flex flex-row justify-evenly'>  
         ...
         <div >      
           { !logggedIn && <Link className='text-violet-50 transition ease-in-out delay-0 hover:text-violet-600 duration-700' to='./pages/Login'>LogIn</Link>}
           { !logggedIn && <span className='ml-2 mr-2 text-violet-50 '>|</span>}
           { !logggedIn && <Link className='text-violet-50 transition ease-in-out delay-0 hover:text-violet-600 duration-700' to='./pages/Signup'>SignUp</Link>}
           { logggedIn && <h1 className=' text-violet-50 flex flex-row '>Logged-In <span> <svg xmlns="http://www.w3.org/2000/svg" height="0.7em" viewBox="0 0 384 512"><path fill='lime' d="M384 192c0 87.4-117 243-168.3 307.2c-12.3 15.3-35.1 15.3-47.4 0C117 435 0 279.4 0 192C0 86 86 0 192 0S384 86 384 192z"/></svg> </span></h1>}
